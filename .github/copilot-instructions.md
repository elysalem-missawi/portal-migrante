...
_Last synced: 2026-08-23T12:11:22.492Z._
...
- `c:\Users\Administrador\OneDrive\Desktop\portal-migrante\portal-migrante\portal-migrante-nuevo\.vscode\mcp.json` _(workspace: portal-migrante-nuevo)_ — _file missing_
...
- **microsoft-foundry** — `C:\Users\Administrador\.agents\skills\microsoft-foundry` — Deploy, evaluate, fine-tune, and manage Foundry agents end-to-end with azd: hosted agent scaffold/run/deploy, prompt agent create, batch eval, continuous eval, prompt optimizer, Agent Optimizer scaffold, agent.yaml, data
